...
const DICT = {
  zh: {
    ...
    // ── x402 Intel Market ──
    x402_hero_eyebrow: 'x402 付费情报市场',
    x402_hero_h1: 'AI 付费解锁高级情报——链上审计追踪。',
    x402_hero_sub: '当免费情报不够用时，AI Agent 通过 <strong>x402 协议</strong>（HTTP 402）支付解锁高级风险数据。每次支付签名（EIP-3009），由 x402 代言人结算并记录上链——为定价引擎提供免费 AI 无法企及的可审计竞争力。',
    x402_paid_services: '付费服务',
    x402_demo_mode: '○ x402 演示模式',
    x402_ready: '● x402 已就绪',
    x402_network_label: '网络: {network}',
    x402_price_range: '价格范围 (USDC)',
    x402_services_heading: '可用服务',
    x402_catalog_heading: '付费情报目录',
    x402_loading: '加载服务中…',
    x402_flow_heading: '实时支付流',
    x402_pipeline_heading: 'x402 结算流水线',
    x402_step1_title: 'HTTP 402 挑战',
    x402_step1_desc: '服务器返回 402 Payment Required 及支付说明',
    x402_step2_title: '签名支付',
    x402_step2_desc: '白 Agent 签署 EIP-3009 转账授权',
    x402_step3_title: '代言人结算',
    x402_step3_desc: 'x402 代言人在链上结算 USDC 支付',
    x402_step4_title: '情报解锁',
    x402_step4_desc: '高级风险情报流入 AI 定价引擎',
    x402_evidence_heading: '链上支付证据',
    x402_evidence_contract: 'PaymentOracle · Injective 测试网',
    x402_tx_hash: '交易哈希',
    x402_service_label: '服务',
    x402_amount_label: '金额',
    x402_response_hash: '响应哈希',
    x402_pricing_impact: '付费情报改变 AI 风险评估',
    x402_before_label: '付费前（免费情报）',
    x402_after_label: '付费后（高级情报）',
    x402_smoke_btn: '🔥 运行 x402 烟雾测试',
    x402_purchase_btn: '💰 购买高级情报 (0.001 USDC)',
    x402_running: '⏳ 正在运行 x402 烟雾测试…',
    x402_initiating: '⏳ 正在启动 x402 购买流程…',
    x402_failed: '✗ 失败',
    x402_error: '错误',
    x402_signed: '✓ 已签名',
    x402_settled: '✓ 已结算',
    ...
    x402_signing_status: '签名中…',
    x402_settling_status: '结算中…',
    x402_pass: 'x402 烟雾测试通过 ✓',
    x402_challenge_log: 'HTTP 402 —— Payment Required 挑战已返回',
    x402_signing_log: 'EIP-3009 —— 白 Agent 签署 TransferWithAuthorization',
    x402_settlement_log: '代言人 —— 结算进行中',
    x402_unlocked_log: '✓ 情报已解锁 —— {events} 个风险事件, {intel} 条深度情报',
    x402_tx_log: '✓ 结算交易: {tx}',
    x402_fail_log: '✗ x402 烟雾测试失败: {msg}',
    x402_price_drop: '↓ 价格下降（检测到更高风险）',
    x402_price_rise: '↑ 价格上升',
    x402_price_nochange: '→ 无变化',
    x402_delta: '差值: {delta}',
    x402_step1_call: '第 1 步: 无支付请求 premium-risk 端点…',
  },
  ...
  en: {
    ...
    // ── x402 Intel Market ──
    x402_hero_eyebrow: 'x402 Paid Intel Market',
    x402_hero_h1: 'AI pays for premium intelligence — on-chain audit trail.',
    x402_hero_sub: 'When free intel isn\'t enough, the AI Agent pays through the <strong>x402 protocol</strong> (HTTP 402) to unlock premium risk data. Every payment is signed (EIP-3009), settled via the x402 facilitator, and recorded on-chain — giving the pricing engine an auditable edge over free-only AI agents.',
    x402_paid_services: 'Paid Services',
    x402_demo_mode: '○ x402 Demo Mode',
    x402_ready: '● x402 Ready',
    x402_network_label: 'Network: {network}',
    x402_price_range: 'Price Range (USDC)',
    x402_services_heading: 'Available services',
    x402_catalog_heading: 'Paid intel catalog',
    x402_loading: 'Loading services…',
    x402_flow_heading: 'Live payment flow',
    x402_pipeline_heading: 'x402 Settlement Pipeline',
    x402_step1_title: 'HTTP 402 Challenge',
    x402_step1_desc: 'Server returns 402 Payment Required with payment instructions',
    x402_step2_title: 'Sign & Pay',
    x402_step2_desc: 'White Agent signs EIP-3009 TransferWithAuthorization',
    x402_step3_title: 'Facilitator Settlement',
    x402_step3_desc: 'x402 facilitator settles USDC payment on-chain',
    x402_step4_title: 'Intel Unlocked',
    x402_step4_desc: 'Premium risk intel flows into the AI pricing engine',
    ...
    x402_service_label: 'Service',
    x402_amount_label: 'Amount',
    x402_response_hash: 'Response hash',
    x402_pricing_impact: 'Paid intel changes the AI\'s risk assessment',
    x402_before_label: 'Before (free intel)',
    x402_after_label: 'After (paid intel)',
    x402_smoke_btn: '🔥 Run x402 Smoke Test',
    x402_purchase_btn: '💰 Purchase Premium Intel (0.001 USDC)',
    x402_running: '⏳ Running x402 smoke test…',
    x402_initiating: '⏳ Initiating x402 purchase flow…',
    x402_failed: '✗ Failed',
    x402_error: 'Error',
    x402_signed: '✓ Signed',
    x402_settled: '✓ Settled',
    x402_unlocked: '✓ Intel Unlocked',
    x402_challenge_status: '402 Returned',
    x402_signing_status: 'Signing…',
    x402_settling_status: 'Settling…',
    x402_pass: 'x402 smoke test passed ✓',
    x402_challenge_log: 'HTTP 402 — Payment Required challenge returned',
    x402_signing_log: 'EIP-3009 — White Agent signing TransferWithAuthorization',
    x402_settlement_log: 'Facilitator — Settlement in progress',
    x402_unlocked_log: '✓ Intel unlocked — {events} risk events, {intel} deep intel entries',
    x402_tx_log: '✓ Settlement tx: {tx}',
    x402_fail_log: '✗ x402 smoke test failed: {msg}',
    x402_price_drop: '↓ price drop (higher risk detected)',
    x402_price_rise: '↑ price rise',
    x402_price_nochange: '→ no change',
    x402_delta: 'delta: {delta}',
    x402_step1_call: 'Step 1: Calling premium-risk endpoint without payment…',
  }
};
